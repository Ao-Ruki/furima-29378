  ...
  describe 'ユーザー新規登録' do
    context '新規登録がうまくいくとき' do
      ...
      it "passwordが6文字以上半角英数字であれば登録できる" do
        ...
        it "passwordが半角英数字を含む場合であれば登録できる" do
          @user.password = "aaaa0000"
          expect(@user).to be_valid
        end
      it "family_nameとfirst_nameが全角漢字であれば登録できる" do
        @user.family_name = "田中"
        @user.first_name = "太朗"
        expect(@user).to be_valid
        end
      it "family_name_kanaとfirst_name_kanaが全角カタカナであれば登録できる" do
    ...
    context '新規登録がうまくいかないとき' do
      ...
      it "nicknameが40文字以上であれば登録できない" do
        @user.nickname = "aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaab"
        @user.valid?
      ...
      it "family_name_kanaが空では登録出来ない" do
      ...
      it "family_nameが全角漢字でなければ登録できない" do
      @user.family_name = "aaa"
      @user.valid?
      expect(@user.errors.full_messages).to include("Family name Full-width characters")
      end
      it "first_nameが全角漢字でなければ登録できない" do
      @user.first_name = "aaa"
      @user.valid?
